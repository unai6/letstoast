...
var inputLocation = document.querySelector('#current--location');
var searchLocation = document.querySelector('.google-class-3');

var searchCocktailBar = function searchCocktailBar() {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      var _position$coords = position.coords,
          latitude = _position$coords.latitude,
          longitude = _position$coords.longitude;
      inputLocation.value = "".concat(latitude, ",").concat(longitude);
    });
  }
};
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/Scripts/index.js"], null)
//# sourceMappingURL=/Scripts.7a2826b4.js.map