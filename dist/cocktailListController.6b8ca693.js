...
},{}],"src/Scripts/Views/cocktailListaginationView.js":[function(require,module,exports) {
"use strict";
...
var PaginationView = /*#__PURE__*/function (_View) {
  ...
  _createClass(PaginationView, [{
    ...
    value: function _generateMarkup() {
      ...
      var numPages = Math.ceil(100 / this._data.resultsPerPage); //Page 1 and more pages
...
},{"./View":"src/Scripts/Views/View.js","../../img/icons.svg":"src/img/icons.svg"}],"src/Scripts/Views/cocktailListresultsView.js":[function(require,module,exports) {
"use strict";
...
var ResultsView = /*#__PURE__*/function (_View) {
  ...
  function ResultsView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_parentEl", document.querySelector('.cocktail--list'));
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/Scripts/Models/CocktailListmodel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchCocktailsController = fetchCocktailsController;
...
function fetchCocktailsController() {
  return _fetchCocktailsController.apply(this, arguments);
}

function _fetchCocktailsController() {
  _fetchCocktailsController = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            data = response.data;
            state.search.results = data.drinks.map(function (drink) {
              return {
                name: drink.strDrink,
...
;
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"src/Scripts/Controllers/cocktailListController.js":[function(require,module,exports) {
"use strict";
...
var _cocktailListaginationView = _interopRequireDefault(require("../Views/cocktailListaginationView"));

var _cocktailListresultsView = _interopRequireDefault(require("../Views/cocktailListresultsView"));

var model = _interopRequireWildcard(require("../Models/CocktailListmodel"));
...
var cocktailsController = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return model.fetchCocktailsController();
  ...
  return function cocktailsController() {
    return _ref.apply(this, arguments);
  };
}();

var getSearchResultsPage = function getSearchResultsPage() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : model.state.search.page;
  model.state.search.page = page;
  var start = (page - 1) * model.state.search.resultsPerPage;
  var end = page * model.state.search.resultsPerPage;
  return model.state.search.results.slice(start, end);
};

var controlPagination = function controlPagination(goToPage) {
  _cocktailListresultsView.default.render(getSearchResultsPage(goToPage));
...
var init = function init() {
  ...
  _cocktailListaginationView.default.addHanderClick(controlPagination);
};

init();
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","../Views/cocktailListaginationView":"src/Scripts/Views/cocktailListaginationView.js","../Views/cocktailListresultsView":"src/Scripts/Views/cocktailListresultsView.js","../Models/CocktailListmodel":"src/Scripts/Models/CocktailListmodel.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/Scripts/Controllers/cocktailListController.js"], null)
//# sourceMappingURL=/cocktailListController.6b8ca693.js.map