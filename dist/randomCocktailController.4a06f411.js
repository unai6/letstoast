...
exports.fetchCocktail = fetchCocktail;
...
function fetchCocktail() {
  return _fetchCocktail.apply(this, arguments);
}

function _fetchCocktail() {
  _fetchCocktail = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, data, drinks, ingredients;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            data = _context.sent;
            drinks = Object.keys(data).filter(function (key) {
            ...
            ingredients = drinks.map(function (drink, index) {
              return {
                drink: JSON.stringify(drink)
              };
            });
            return _context.abrupt("return", state.cocktail = {
              name: data.strDrink,
...
},{"axios":"node_modules/axios/index.js"}],"src/Scripts/Controllers/randomCocktailController.js":[function(require,module,exports) {
"use strict";
...
if (logoutBtn && sessionStorage.length > 0) {
  ...
  nav.forEach(function (item) {
    return item.classList.add('no-nav');
  });
} else if (logoutBtn && sessionStorage.length === 0) {
  logoutBtn.style.display = 'none';
  nav.forEach(function (item) {
    return item.classList.remove('no-nav');
  });
}
...
function _addList() {
  _addList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var cocktail;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return model.fetchCocktail();

          case 2:
            cocktail = model.state.cocktail;

            _randomCocktailView.default.render(cocktail);
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/Scripts/Controllers/randomCocktailController.js"], null)
//# sourceMappingURL=/randomCocktailController.4a06f411.js.map